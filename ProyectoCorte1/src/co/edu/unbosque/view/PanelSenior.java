...
public class PanelSenior extends JPanel{
	...
	private static String BOTONVOLVERSENIOR = "BOTONVOLVERSENIOR";
	private static String BOTONACEPTARSENIOR = "BOTONACEPTARSENIOR";
	...
	public PanelSenior () {
		...
		botonAceptar.setActionCommand("BOTONACEPTARSENIOR");
		
		volver = new JButton("Volver");
		volver.setEnabled(true);
		volver.setActionCommand("BOTONVOLVERSENIOR");
	...
	public static String getBOTONVOLVERSENIOR() {
		return BOTONVOLVERSENIOR;
	}


	public static void setBOTONVOLVERSENIOR(String bOTONVOLVERSENIOR) {
		BOTONVOLVERSENIOR = bOTONVOLVERSENIOR;
	}


	public static String getBOTONACEPTARSENIOR() {
		return BOTONACEPTARSENIOR;
	}


	public static void setBOTONACEPTARSENIOR(String bOTONACEPTARSENIOR) {
		BOTONACEPTARSENIOR = bOTONACEPTARSENIOR;
	}
